    ...
    <div class="product-section">
        <div class="container">
            <div class="row">
                ...
                <div style="padding-left:130px;color:red; ">
                    <h2>
                        please insert your data ,then enjoy with our products
                    </h2>
                </div>
                <!-- End Column 1 -->
                    ...
                    <form action="{{ route('shop') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6 mb-5 mb-md-0">
                                ...
                                <div class="p-3 p-lg-5 border bg-white">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"class="@error('first_name') is-invalid @enderror"
                                                class="form-control" id="c_fname" name="first_name">
                                            @error('first_name')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"class="@error('last_name') is-invalid @enderror"
                                                class="form-control" id="c_lname" name="last_name">
                                            @error('last_name')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row mb-5">
                                        <div class="col-md-6">
                                            <label for="c_postal_zip" class="text-black">cupon code <span
                                                    class="text-danger">*</span></label>
                                            <input type="text"class="@error('cupon_code') is-invalid @enderror"
                                                class="form-control" id="cupon_code" name="cupon_code">
                                            @error('cupon_code')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="@error('order_notes') is-invalid @enderror" name="order_notes" id="c_order_notes" cols="30"
                                            rows="5" class="form-control" placeholder="Write your notes here..."></textarea>
                                        @error('order_notes')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <!-- Start Column 2 -->
                            @foreach ($product->take(2) as $product)
                            ...
                            @endforeach
                            <!-- End Column 2 -->
                            <p><button class="btn">Shop Now</button></p>
